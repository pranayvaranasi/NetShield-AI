...
st.set_page_config(page_title="NetShield AI", layout="wide", page_icon=":shield:")
...
def main():
    ...
    st.sidebar.write("Powered by Deep Learning")
    st.sidebar.write("Built with Streamlit, Plotly, and Scikit-learn")
    st.sidebar.write("Crafted by Pranay Varanasi")
